...
export default async ({ github, context, core }) => {
	try {
		// Load configurations
		const labelConfig = yaml.parse(fs.readFileSync('.github/config/labels.yml', 'utf8'))
		const labelerConfig = yaml.parse(fs.readFileSync('.github/config/labeler.yml', 'utf8'))
